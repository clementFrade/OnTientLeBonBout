...
import fr.telecom_st_etienne.ontientlebonbout.repository.search.QuestionSearchRepository;
...
public class QuestionResourceIT {
     ...
     *
     * @see fr.telecom_st_etienne.ontientlebonbout.repository.search.QuestionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final QuestionResource questionResource = new QuestionResource(questionRepository, mockQuestionSearchRepository);
