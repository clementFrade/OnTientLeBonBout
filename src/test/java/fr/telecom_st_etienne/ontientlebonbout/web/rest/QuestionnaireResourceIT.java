...
public class QuestionnaireResourceIT {
     ...
     *
     * @see fr.telecom_st_etienne.ontientlebonbout.repository.search.QuestionnaireSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final QuestionnaireResource questionnaireResource = new QuestionnaireResource(questionnaireRepository, mockQuestionnaireSearchRepository);
    ...
    public void searchQuestionnaire() throws Exception {
        // Initialize the database
        questionnaireRepository.saveAndFlush(questionnaire);
        when(mockQuestionnaireSearchRepository.search(queryStringQuery("id:" + questionnaire.getId())))
            .thenReturn(Collections.singletonList(questionnaire));
