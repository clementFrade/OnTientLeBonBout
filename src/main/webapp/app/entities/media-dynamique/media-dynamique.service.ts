...
export class MediaDynamiqueService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/media-dynamiques';
  ...
  search(req: Search): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IMediaDynamique[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
